...
mutable struct Reactran{T,chunk_size}
    ...
    RMnO2H2S_Nd::PreallocationTools.DiffCache{
        Array{T,1},
        Array{ForwardDiff.Dual{nothing,T,chunk_size},1},
    }
    RFeOOHPOC_Nd::PreallocationTools.DiffCache{
        Array{T,1},
        Array{ForwardDiff.Dual{nothing,T,chunk_size},1},
    }
    RFeOOHH2S_Nd::PreallocationTools.DiffCache{
        Array{T,1},
        Array{ForwardDiff.Dual{nothing,T,chunk_size},1},
    }
    RO2Mn_Ndnr::PreallocationTools.DiffCache{
        Array{T,1},
        Array{ForwardDiff.Dual{nothing,T,chunk_size},1},
    }
    RO2Mn_Ndr::PreallocationTools.DiffCache{
        Array{T,1},
        Array{ForwardDiff.Dual{nothing,T,chunk_size},1},
    }
    RO2Fe_Ndnr::PreallocationTools.DiffCache{
        Array{T,1},
        Array{ForwardDiff.Dual{nothing,T,chunk_size},1},
    }
    RO2Fe_Ndr::PreallocationTools.DiffCache{
        Array{T,1},
        Array{ForwardDiff.Dual{nothing,T,chunk_size},1},
    }
    ...
    S_Ndr::PreallocationTools.DiffCache{
        Array{T,1},
        Array{ForwardDiff.Dual{nothing,T,chunk_size},1},
    }
...
function init(
    ...
    RFeOOHH2S_Nd =
        PreallocationTools.dualcache(zeros(T, Ngrid), Val{chunk_size})
    RO2Mn_Ndnr = PreallocationTools.dualcache(zeros(T, Ngrid), Val{chunk_size})
    RO2Mn_Ndr = PreallocationTools.dualcache(zeros(T, Ngrid), Val{chunk_size})
    RO2Fe_Ndnr = PreallocationTools.dualcache(zeros(T, Ngrid), Val{chunk_size})
    RO2Fe_Ndr = PreallocationTools.dualcache(zeros(T, Ngrid), Val{chunk_size})
    RNdnrPO4_pre =
        PreallocationTools.dualcache(zeros(T, Ngrid), Val{chunk_size})
