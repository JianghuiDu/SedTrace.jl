...
b = 3.5 # missing # missing
A =
    1 / 2b *
    log((1 + (exp(b) - 1) * 0.055 / L) / (1 + (exp(-b) - 1) * 0.055 / L)) # missing # missing
...
# solute diffusivity
#----------------------------------------------
DO2 = 6.0723023413552119E+02 ./ (1.0 .- 2log.(phif)) # cm^2 yr^-1 # Sediment diffusion coefficient
...
DCO2 = 5.0911879892585188E+02 ./ (1.0 .- 2log.(phif)) # cm^2 yr^-1 # Sediment diffusion coefficient
...
TH3BO30 = 4.8984470290102364e-5 # missing # missing
O20 = 0.00025 # missing # missing
pHL = 7.39 # free pH scale # pH at the TOP of sediment column
TCO2L = 0.002 # mmol cm^-3 # Concentration of TCO2 at the TOP of sediment column
TH2SL = 0.000383 # mmol cm^-3 # Concentration of TH2S at the TOP of sediment column
TH3BO3L = 4.8984470290102364e-5 # missing # missing
O2L = 0.0 # missing # missing
...
# Reaction parameters
#----------------------------------------------
a = 10000.0 # missing # missing
x0 = 0.005 # cm # missing
kOS = 78.0 # missing # missing
