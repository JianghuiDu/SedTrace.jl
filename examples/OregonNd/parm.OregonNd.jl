...
const Nmat = 5400 #  # Jacobian dimention
...
const NH4_ads0 = NH40 * KNH4_ads # missing # missing
...
const BcNdnr_ads_Mn =
    ((phis[1]us[1], -phis[1]Ds[1], FNdnr_ads_Mn0), (0.0, 1.0, 0.0)) #  # Boundary condition of Ndnr_ads_Mn
const BcNdnr_ads_Fe =
    ((phis[1]us[1], -phis[1]Ds[1], FNdnr_ads_Fe0), (0.0, 1.0, 0.0)) #  # Boundary condition of Ndnr_ads_Fe
const BcNdr_ads_Mn =
    ((phis[1]us[1], -phis[1]Ds[1], FNdr_ads_Mn0), (0.0, 1.0, 0.0)) #  # Boundary condition of Ndr_ads_Mn
const BcNdr_ads_Fe =
    ((phis[1]us[1], -phis[1]Ds[1], FNdr_ads_Fe0), (0.0, 1.0, 0.0)) #  # Boundary condition of Ndr_ads_Fe
const BcFe_ads_Mn =
    ((phis[1]us[1], -phis[1]Ds[1], FFe_ads_Mn0), (0.0, 1.0, 0.0)) #  # Boundary condition of Fe_ads_Mn
const BcFe_ads_Fe =
    ((phis[1]us[1], -phis[1]Ds[1], FFe_ads_Fe0), (0.0, 1.0, 0.0)) #  # Boundary condition of Fe_ads_Fe
const BcMn_ads_Mn =
    ((phis[1]us[1], -phis[1]Ds[1], FMn_ads_Mn0), (0.0, 1.0, 0.0)) #  # Boundary condition of Mn_ads_Mn
const BcMn_ads_Fe =
    ((phis[1]us[1], -phis[1]Ds[1], FMn_ads_Fe0), (0.0, 1.0, 0.0)) #  # Boundary condition of Mn_ads_Fe
const BcNH4_ads = ((1.0, 0.0, NH4_ads0), (0.0, 1.0, 0.0)) #  # Boundary condition of NH4_ads
...
const C0 = repeat(C_ini, outer = Ngrid) # initial conditions
