function (f::Cache.Reactran)(dC, C, parms, t)
    ...
    @.. Ndnr_free =
        H ⊗ Ndnr / (
            H ⊗ (
                33884415613.9202 ⊗ CO3^2 ⊕ 954992.586021437 ⊗ CO3 ⊕
                0.398107170553497 ⊗ Cl ⊕ 21.3796208950223 ⊗ HCO3 ⊕
                83.1763771102671 ⊗ SO4
            ) ⊕ H ⊕ 3.23593656929628e-9
        )
    @.. Ndr_free =
        H ⊗ Ndr / (
            H ⊗ (
    ...
    @.. RNdnrPO4_pre =
        ...
        (kNdPO4 ⊗ fNdnr ⊗ (Omega_RNdnrPO4_pre - 1))
    @.. RNdrPO4_pre =
        (tanh(100.0 ⊗ (Omega_RNdrPO4_pre - 1.0)) / 2 ⊕ 0.5) ⊗
        (kNdPO4 ⊗ Ndr / Ndnr ⊗ fNdnr ⊗ (Omega_RNdrPO4_pre - 1))
    ...
    @.. S_Ndnr =
        rNdnrMn ⊗ RMnO2POC_Nd ⊕ rNdnrFe ⊗ RFeOOHPOC_Nd ⊕ -1 ⊗ RNdnrPO4_pre
    @.. S_Ndr = rNdrMn ⊗ RMnO2POC_Nd ⊕ rNdrFe ⊗ RFeOOHPOC_Nd ⊕ -1 ⊗ RNdrPO4_pre
    @.. S_TA =
