...
const DH3SiO4 = 2.7202367899659810E-307 ./ (1.0 .- 2log.(phif)) .+ 15Ds # cm^2 yr^-1 # Sediment diffusion coefficient
...
const betaH3SiO4 = 5.4404735799319620E-306 # cm yr^-1 # solute mass transfer velocity across SWI
