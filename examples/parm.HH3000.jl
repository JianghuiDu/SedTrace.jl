...
const Ngrid = 5 # integer # number of model grid
...
const DH3SiO4 = 3.6298372644602551E-307 ./ (1.0 .- 2log.(phif)) .+ 15Ds # cm^2 yr^-1 # Sediment diffusion coefficient
...
const betaH3SiO4 = 7.2596745289205102E-306 # cm yr^-1 # solute mass transfer velocity across SWI
