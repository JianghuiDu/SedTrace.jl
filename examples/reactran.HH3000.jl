function reactran_fvcf_auto(dC, C, parms, t)
    ...
    @. dTA_dTCO2 = KCO2 * (H + 2.0 * KHCO3) / (H^2 + H * KCO2 + KCO2 * KHCO3)
    ...
    @. TA_tran +=
        -1.0 * H3PO4_tran + 0.0 * H2PO4_tran + 1.0 * HPO4_tran + 2.0 * PO4_tran
    ...
    @. Fe_free =
        Fe * H / (
            H * (
                38404.8078076036 * CO3^2 +
                1141.13847737758 * CO3 +
                0.541149470776101 * Cl +
                3.75214432319968 * HCO3 +
                409766.824665317 * HS +
                390245.286156751 * OH^2 +
                3971.47624308745 * OH +
                6.626643393432 * SO4
            ) +
            H +
            0.00150222599838656 * HS
        )
    @. Al_free =
        Al / (
            1889348.44155961 * CO3 +
            5.71374695230749e+39 * OH^4 +
            1.2556441493638e+31 * OH^3 +
            5.63992735079517e+20 * OH^2 +
            7872134080.00216 * OH +
            1
        )
    @. Ndnr_free =
        H * Ndnr / (
            H * (
                3632465961.77468 * CO3^2 +
                290431.690955537 * CO3 +
                0.343269152592752 * Cl +
                63095734448.0194 * H3SiO4^2 +
                158489.319246111 * H3SiO4 +
                7.38572662109916 * HCO3 +
                56.0142660345257 * SO4
            ) +
            H +
            9.62959782270152e-10
        )
    @. Ndr_free =
        H * Ndr / (
            H * (
    ...
    @. S_Ndnr =
        rNdnrMn * RMnO2POC_Nd +
        rNdnrMn * RMnO2H2S_Nd +
        rNdnrFe * RFeOOHPOC_Nd +
        rNdnrFe * RFeOOHH2S_Nd +
        -1 * RO2Mn_Ndnr +
        -1 * RO2Fe_Ndnr +
        -1 * RNdnrPO4_pre
    @. S_Ndr =
    ...
    @. S_TA =
        ...
        (1.0 * rNC - 1.0 * rPC) * RCH4POC * dstopw +
        -2 * RO2NH4 +
        -2 * RO2Mn +
        -1 * RO2Mn_ads * dstopw +
        -2 * RO2Fe +
