...
@with_kw mutable struct ParamStruct{T}
    ...
    AmTMn_ads_nsf::Tridiagonal{T,Vector{T}} = AmTMn_ads_nsf
    AmTFe_dis::Tridiagonal{T,Vector{T}} = AmTFe_dis
    AmTFe_ads_nsf::Tridiagonal{T,Vector{T}} = AmTFe_ads_nsf
    ...
    BcAmTMn_ads_nsf::Vector{T} = BcAmTMn_ads_nsf
    BcCmTMn_ads_nsf::Vector{T} = BcCmTMn_ads_nsf
    BcAmTFe_dis::Vector{T} = BcAmTFe_dis
    BcCmTFe_dis::Vector{T} = BcCmTFe_dis
    BcAmTFe_ads_nsf::Vector{T} = BcAmTFe_ads_nsf
    BcCmTFe_ads_nsf::Vector{T} = BcCmTFe_ads_nsf
