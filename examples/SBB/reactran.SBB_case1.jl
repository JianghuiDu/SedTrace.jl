function (f::Cache.Reactran)(dC, C, parms::Param.ParamStruct, t)
    ...
    RMol_rm1 = PreallocationTools.get_tmp(f.RMol_rm1, C)
    RMoh_rm1 = PreallocationTools.get_tmp(f.RMoh_rm1, C)
    ...
    @.. MolO4_aq =
        1.3405176215757213e-20 ⊗ Mol_dis / (
            ...
            1.3136717255533756e-10 ⊗ H2S^2 ⊕ 2.0791226725998499e-15 ⊗ H2S ⊕
    ...
    @.. MohO4_aq =
        1.3489628825916504e-20 ⊗ Moh_dis / (
            ...
            1.3182567385564045e-10 ⊗ H2S^2 ⊕ 2.0892961308540363e-15 ⊗ H2S ⊕
    ...
    @.. RMol_rm1 = kMo_rm1 ⊗ (MolS4_aq ⊕ MolOS3_aq ⊕ MolO2S2_aq ⊕ MolO3S_aq)
    @.. RMoh_rm1 = kMo_rm1 ⊗ (MohS4_aq ⊕ MohOS3_aq ⊕ MohO2S2_aq ⊕ MohO3S_aq)
    ...
    @.. S_THF = -2.48 ⊗ RCFA_pre
    @.. S_Mol = -1 ⊗ RMol_rm1 ⊕ -1 ⊗ RMol_rm1 ⊕ -1 ⊗ RMol_rm1 ⊕ -1 ⊗ RMol_rm1
    @.. S_SMol = 4 ⊗ RMol_rm1 ⊗ pwtods
    @.. S_Moh = -1 ⊗ RMoh_rm1 ⊕ -1 ⊗ RMoh_rm1 ⊕ -1 ⊗ RMoh_rm1 ⊕ -1 ⊗ RMoh_rm1
    @.. S_SMoh = 4 ⊗ RMoh_rm1 ⊗ pwtods
    @.. S_TA =
