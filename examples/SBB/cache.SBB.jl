...
mutable struct Reactran{T,chunk_size}
    ...
    Omega_RASi_pre::PreallocationTools.DiffCache{
        Array{T,1},
        Array{ForwardDiff.Dual{nothing,T,chunk_size},1},
    }
    Omega_RMoS4_pre::PreallocationTools.DiffCache{
        Array{T,1},
        Array{ForwardDiff.Dual{nothing,T,chunk_size},1},
    }
    ...
    RASi_pre::PreallocationTools.DiffCache{
        Array{T,1},
        Array{ForwardDiff.Dual{nothing,T,chunk_size},1},
    }
    RMoS4_pre::PreallocationTools.DiffCache{
        Array{T,1},
        Array{ForwardDiff.Dual{nothing,T,chunk_size},1},
    }
    ...
    S_Mo::PreallocationTools.DiffCache{
        Array{T,1},
        Array{ForwardDiff.Dual{nothing,T,chunk_size},1},
    }
    S_MoS4::PreallocationTools.DiffCache{
        Array{T,1},
        Array{ForwardDiff.Dual{nothing,T,chunk_size},1},
    }
...
function init(
    ...
    RASi_pre = PreallocationTools.dualcache(zeros(T, Ngrid), Val{chunk_size})
    RMoS4_pre = PreallocationTools.dualcache(zeros(T, Ngrid), Val{chunk_size})
    ...
    S_Mo = PreallocationTools.dualcache(zeros(T, Ngrid), Val{chunk_size})
    S_MoS4 = PreallocationTools.dualcache(zeros(T, Ngrid), Val{chunk_size})
