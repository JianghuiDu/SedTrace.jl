...
function EquilibriumInvariant(Tsum)
    ...
    elseif Tsum == "TH3PO4"
        return EquilibriumInvariant(
            ...
            2.0*KH2PO4*KH3PO4*KHPO4/(H^3 + H^2*KH3PO4 + H*KH2PO4*KH3PO4 + KH2PO4*KH3PO4*KHPO4) +
            -H^3/(H^3 + H^2*KH3PO4 + H*KH2PO4*KH3PO4 + KH2PO4*KH3PO4*KHPO4)",
            "-KH2PO4*KH3PO4*TH3PO4*(2.0*H^3 + H^2*KH3PO4 - KH2PO4*KH3PO4*KHPO4)/(H^3 + H^2*KH3PO4 + H*KH2PO4*KH3PO4 + KH2PO4*KH3PO4*KHPO4)^2 +
            -2.0*KH2PO4*KH3PO4*KHPO4*TH3PO4*(3.0*H^2 + 2.0*H*KH3PO4 + KH2PO4*KH3PO4)/(H^3 + H^2*KH3PO4 + H*KH2PO4*KH3PO4 + KH2PO4*KH3PO4*KHPO4)^2 +
            -H^2*KH3PO4*TH3PO4*(H^2 + 2.0*H*KH2PO4 + 3.0*KH2PO4*KHPO4)/(H^3 + H^2*KH3PO4 + H*KH2PO4*KH3PO4 + KH2PO4*KH3PO4*KHPO4)^2",
        )
    elseif Tsum == "TH2S"
        return EquilibriumInvariant(
            "TH2S",
